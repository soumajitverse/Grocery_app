...
const ProductCard = ({ product }) => {
    ...
    return product && (
        <div onClick={() => {
            // it will navigate to specific to product that is clicked
            navigate(`/products/${product.category.toLowerCase()}/${product._id}`)
            scrollTo(0, 0)
        }} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-5 max-w-56 w-full">
